! function() {
    ...
    t.prototype.init = function() {
        ...
        if (this.disabled(this.conf.disabled), this.valRange && (this.conf.values = s(this.conf)), this.values.start = 0, this.values.end = this.conf.range ? this.conf.values.length - 1 : 770, this.conf.set && this.conf.set.length && n(this.conf)) {
            var t = [8000];
